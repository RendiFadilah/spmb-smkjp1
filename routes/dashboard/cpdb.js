...
router.get('/', isAuthenticated, async (req, res) => {
    try {
        ...
        res.render('dashboard/cpdb/index', {
            title: 'Dashboard CPDB - SPMB SMK YP 17 Baradatu',
            description: 'Dashboard CPDB SPMB SMK YP 17 Baradatu',
            user: req.user,
...
router.get('/settings', isAuthenticated, (req, res) => {
    res.render('dashboard/cpdb/settings', {
        title: 'Pengaturan Akun - SPMB SMK YP 17 Baradatu',
        description: 'Pengaturan akun CPDB SPMB SMK YP 17 Baradatu',
        user: req.user,
        layout: 'layouts/dashboard-cpdb',
